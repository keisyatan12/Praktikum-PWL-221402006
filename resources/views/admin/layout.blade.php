    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                ...
                <div class="sidebar-brand-text mx-3">Pastry Admin <sup>~</sup></div>
            </a>
            ...
            <li class="nav-item  {{request()->is('admin/harga')? 'active': ''}}">
                <a class="nav-link" href="/admin/harga">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Daftar Harga</span></a>
            </li>

            <!-- Nav Item - Stok bahan baku-->
            <li class="nav-item  {{request()->is('admin/stok')? 'active': ''}}">
                <a class="nav-link" href="/admin/stok">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Stok Bahan Baku</span></a>
            </li>
